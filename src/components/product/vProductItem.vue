...
<div class="product-item-order">
  <div class="product-item-order__img">
  ...
  <div class="product-item-order__content">
    <div class="product-item-order__content-left">
      <div class="product-item-order__content-title">{{ item.title }}</div>
      ...
      <div class="product-item-order__content-box">
        ...
        <div v-if="canDelete" class="product-item-order__content-delete">
          <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
